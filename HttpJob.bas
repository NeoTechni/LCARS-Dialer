...
Sub SaveFile(Dir As String, Filename As String) As Boolean 
	Dim  FS As OutputStream ,Iss As InputStream
...
Public Sub GetString2(Encoding As String) As String
	...
	If Not(File.Exists(HttpUtils2Service.TempFolder, taskId)) Then Return False 
...
Public Sub GetBitmap As Bitmap
	Dim b As Bitmap
	If Not(File.Exists(HttpUtils2Service.TempFolder, taskId)) Then Return b 
...
Public Sub GetInputStream As InputStream
	Dim In As InputStream
	If Not(File.Exists(HttpUtils2Service.TempFolder, taskId)) Then Return In 
